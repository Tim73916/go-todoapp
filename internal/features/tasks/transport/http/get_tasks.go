...
// @Description Get a list of tasks with optional pagination and/or filtering by author ID
// @Tags tasks
// @Produce json
// @Param user_id query int false "Filter tasks by author ID"
// @Param limit query int false "Page size for tasks"
// @Param offset query int false "Page offset for tasks"
// @Success 200 {object} GetTasksResponse "Tasks list successfully retrieved"
